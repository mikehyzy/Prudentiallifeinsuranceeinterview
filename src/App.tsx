  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="relative px-12 shadow-2xl mb-12 overflow-hidden" style={{ paddingTop: '60px', paddingBottom: '40px', background: 'linear-gradient(to right, #0046B8, #003087)' }}>
